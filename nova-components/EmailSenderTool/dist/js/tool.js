...
Nova.booting(function (Vue, router, store) {
  Vue.component('email-sender-tool', __webpack_require__(2));
});
    ...
    methods: {
        sendEmail: function sendEmail() {
            ...
            Nova.request().post('/nova-vendor/email-sender-tool/getCustomerEmail', {
                ...
                _this.emailSentResponse = response.data;
            });
        },
        selectTemplateEvent: function selectTemplateEvent() {
            var _this2 = this;

            Nova.request().post('/nova-vendor/email-sender-tool/selectTemplateEvent', {
                'name': this.selectedTemplate
            }).then(function (response) {
                _this2.selectedTemplateResponse = response.data;
                _this2.emailSubject = _this2.selectedTemplateResponse['subject'];
                _this2.emailBody = _this2.selectedTemplateResponse['body'];
            });
        },
        getTemplate: function getTemplate() {
            var _this3 = this;

            Nova.request().get('/nova-vendor/email-sender-tool/getTemplate').then(function (response) {
                _this3.getTemplateResponse = response.data;
            });
        }
    }
});
...
var render = function() {
  ...
  return _c("div", { attrs: { id: "form-main" } }, [
    _c("div", { attrs: { id: "form-div" } }, [
      ...
      _c("p", { staticClass: "text" }, [
        _c("textarea", {
          ...
          staticClass: "feedback-input",
          attrs: { name: "text", id: "comment", placeholder: "Comment" },
          ...
          "select",
          {
            ...
            on: {
              change: [
                ...
                function($event) {
                  return _vm.selectTemplateEvent()
                }
              ]
            }
          },
          _vm._l(_vm.getTemplateResponse, function(template) {
            return _c("option", [_vm._v(_vm._s(template))])
          }),
          0
        )
      ]),
      ...
      _c("div", { staticClass: "submit" }, [
        _c(
          "button",
          {
            attrs: { value: "SEND", id: "button-blue" },
            on: {
      ...
      _c("h3", { staticStyle: { color: "green" } }, [
        _vm._v(_vm._s(this.emailSentResponse))
      ])
    ])
  ])
}
